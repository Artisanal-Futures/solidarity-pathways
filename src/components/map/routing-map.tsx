...
import RouteMarker, {
  PositionIcon,
  StopIcon,
} from "~/components/map/route-marker";
...
import type { GeoJsonData, Stop } from "~/types";

import { MapPopup } from "~/components/map/map-popup.wip";
...
const RoutingMap = forwardRef<MapRef, MapProps>(
  ({ className, children, showAdvanced }, ref) => {
    ...
    const assignAnIcon2 = (
      ...
      return StopIcon(color, text_overlay);
    };
